...
try:
    EMBEDDING_MODEL_NAME = config.DOC_EMBEDDING_MODEL_NAME  # Using Qwen for page embeddings
    EMBEDDING_DIMENSION = config.DOC_EMBEDDING_DIMENSION  # 1536 for Qwen
...
def save_document_to_lancedb(document_path):
    ...
    try:
        ...
        text_embedder = SentenceTransformer(EMBEDDING_MODEL_NAME, trust_remote_code=True)
